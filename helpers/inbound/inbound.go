...
Check out <a href="https://github.com/sendgrid/sendgrid-go/tree/master/helpers/inbound">the documentation</a> on how to use this software to utilize the SendGrid Inbound Parse webhook.
</body>
</html>`
...
func TestSender() {
	...
	if err != nil {
		log.Fatal("Check your Filepath and Host. ", err)
	}
}
