...
func TestV3AddPersonalizations(t *testing.T) {
	...
	if len(m.Personalizations) != numOfPersonalizations {
		t.Errorf("Mail should have %v personalizations, got %d personalizations", personalizations, len(m.Personalizations))
	}
}
...
func TestV3AddContent(t *testing.T) {
	...
	if len(m.Content) != numOfContent {
		t.Errorf("Mail should have %v contents, got %d contents", content, len(m.Content))
	}
}
...
func TestV3AddAttachment(t *testing.T) {
	...
	if len(m.Attachments) != numOfAttachments {
		t.Errorf("Mail should have %v attachments, got %d attachments", attachment, 2)
	}
}
