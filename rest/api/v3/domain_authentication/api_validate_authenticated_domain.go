...
func (params *ValidateAuthenticatedDomainParam) SetId(Id int32) *ValidateAuthenticatedDomainParam {
	params.Id = &Id
	return params
}
func (params *ValidateAuthenticatedDomainParam) SetOnbehalfof(Onbehalfof string) *ValidateAuthenticatedDomainParam {
...
func (c *ApiService) ValidateAuthenticatedDomain(params *ValidateAuthenticatedDomainParam) (interface{}, error) {
	...
	if resp.StatusCode == 200 {
		ps := &ValidateAuthenticatedDomain200Response{}
	...
	if resp.StatusCode == 500 {
		ps := &ValidateAuthenticatedDomain500Response{}
		if err := json.NewDecoder(resp.Body).Decode(ps); err != nil {
			return nil, err
		}
