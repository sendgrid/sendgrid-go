...
------------- | ------------- | -------------
[**ListAuthenticatedDomain**](ListAuthenticatedDomain.md#ListAuthenticatedDomain) | **Get** /v3/whitelabel/domains | List all authenticated domains



## ListAuthenticatedDomain

> []interface{} ListAuthenticatedDomain(ctx, optional)
...
Other parameters are passed through a pointer to a ListAuthenticatedDomainParams struct
...
**ExcludeSubusers** | **bool** | Exclude subuser domains from the result.
