...
// ListFieldDefinition200Response struct for ListFieldDefinition200Response
type ListFieldDefinition200Response struct {
	CustomFields   []CustomFieldDefinitionsResponse        `json:"custom_fields"`
	ReservedFields []ReservedFieldDefinitionsResponseInner `json:"reserved_fields"`
