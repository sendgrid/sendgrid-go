...
// ReservedFieldDefinitionsResponseInner struct for ReservedFieldDefinitionsResponseInner
type ReservedFieldDefinitionsResponseInner struct {
	Name      *string     `json:"name,omitempty"`
	FieldType *FieldType1 `json:"field_type,omitempty"`
