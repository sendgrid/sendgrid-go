...
// CreateFieldDefinition200Response struct for CreateFieldDefinition200Response
type CreateFieldDefinition200Response struct {
	Id        string     `json:"id"`
	Name      string     `json:"name"`
	FieldType FieldType2 `json:"field_type"`
