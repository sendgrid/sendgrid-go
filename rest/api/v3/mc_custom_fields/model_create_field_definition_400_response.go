...
// CreateFieldDefinition400Response struct for CreateFieldDefinition400Response
type CreateFieldDefinition400Response struct {
	Errors []CustomFieldsError `json:"errors"`
}
