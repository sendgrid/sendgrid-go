...
type DeleteFieldDefinitionParam struct {
	//
	CustomFieldId *string `json:"custom_field_id"`
}

func (params *DeleteFieldDefinitionParam) SetCustomFieldId(CustomFieldId string) *DeleteFieldDefinitionParam {
...
func (c *ApiService) DeleteFieldDefinition(params *DeleteFieldDefinitionParam) (interface{}, error) {
