...
// ValidateReverseDns500Response struct for ValidateReverseDns500Response
type ValidateReverseDns500Response struct {
	// The error messages for the failed validation.
	Errors []ValidateReverseDns500ResponseErrorsInner `json:"errors"`
}
