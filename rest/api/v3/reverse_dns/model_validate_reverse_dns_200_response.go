...
// ValidateReverseDns200Response struct for ValidateReverseDns200Response
type ValidateReverseDns200Response struct {
	// The ID of the reverse DNS record.
	Id int32 `json:"id"`
	// Indicates if the reverse DNS record is valid.
	Valid             Valid                                          `json:"valid"`
	ValidationResults ValidateReverseDns200ResponseValidationResults `json:"validation_results"`
}
