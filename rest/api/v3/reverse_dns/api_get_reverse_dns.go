...
type GetReverseDnsParam struct {
...
func (params *GetReverseDnsParam) SetId(Id string) *GetReverseDnsParam {
	params.Id = &Id
	return params
}
func (params *GetReverseDnsParam) SetOnbehalfof(Onbehalfof string) *GetReverseDnsParam {
...
func (c *ApiService) GetReverseDns(params *GetReverseDnsParam) (interface{}, error) {
