...
// ValidateReverseDns404Response struct for ValidateReverseDns404Response
type ValidateReverseDns404Response struct {
	// The error messages for the failed validation.
	Errors []ValidateReverseDns404ResponseErrorsInner `json:"errors"`
}
