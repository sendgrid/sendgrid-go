...
// ValidateReverseDns200ResponseValidationResults The specific results of the validation.
type ValidateReverseDns200ResponseValidationResults struct {
	ARecord *ValidateReverseDns200ResponseValidationResultsARecord `json:"a_record,omitempty"`
}
