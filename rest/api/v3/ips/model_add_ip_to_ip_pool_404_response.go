...
// AddIpToIpPool404Response struct for AddIpToIpPool404Response
type AddIpToIpPool404Response struct {
	// The error returned.
	Errors *[]AddIpToIpPool404ResponseErrorsInner `json:"errors,omitempty"`
}
