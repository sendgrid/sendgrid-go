...
// ListRemainingIpCount200Response struct for ListRemainingIpCount200Response
type ListRemainingIpCount200Response struct {
	Results []ListRemainingIpCount200ResponseResultsInner `json:"results"`
}
