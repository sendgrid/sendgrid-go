...
// GetSuppressionBouncesClassifications200ResponseResultInner struct for GetSuppressionBouncesClassifications200ResponseResultInner
type GetSuppressionBouncesClassifications200ResponseResultInner struct {
	Date  *string                                                                 `json:"date,omitempty"`
	Stats *[]GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner `json:"stats,omitempty"`
}
