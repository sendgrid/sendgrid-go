...
// ListSuppressionBouncesClassifications200ResponseResultInner struct for ListSuppressionBouncesClassifications200ResponseResultInner
type ListSuppressionBouncesClassifications200ResponseResultInner struct {
	Date  *string                                                                  `json:"date,omitempty"`
	Stats *[]ListSuppressionBouncesClassifications200ResponseResultInnerStatsInner `json:"stats,omitempty"`
}
