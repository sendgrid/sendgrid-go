...
type DeleteInvalidEmailsParam struct {
	...
	//
	DeleteInvalidEmailsRequest *DeleteInvalidEmailsRequest `json:"DeleteInvalidEmailsRequest,omitempty"`
}

func (params *DeleteInvalidEmailsParam) SetOnbehalfof(Onbehalfof string) *DeleteInvalidEmailsParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *DeleteInvalidEmailsParam) SetDeleteInvalidEmailsRequest(DeleteInvalidEmailsRequest DeleteInvalidEmailsRequest) *DeleteInvalidEmailsParam {
	params.DeleteInvalidEmailsRequest = &DeleteInvalidEmailsRequest
	return params
}
...
func (c *ApiService) DeleteInvalidEmails(params *DeleteInvalidEmailsParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.DeleteInvalidEmailsRequest != nil {
		b, err := json.Marshal(*params.DeleteInvalidEmailsRequest)
		if err != nil {
			return nil, err
		}
		body = b
