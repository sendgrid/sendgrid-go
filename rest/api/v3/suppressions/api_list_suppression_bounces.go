...
type ListSuppressionBouncesParam struct {
	//
...
func (params *ListSuppressionBouncesParam) SetAccept(Accept string) *ListSuppressionBouncesParam {
	params.Accept = &Accept
	return params
}
func (params *ListSuppressionBouncesParam) SetStartTime(StartTime int32) *ListSuppressionBouncesParam {
	params.StartTime = &StartTime
	return params
}
func (params *ListSuppressionBouncesParam) SetEndTime(EndTime int32) *ListSuppressionBouncesParam {
	params.EndTime = &EndTime
	return params
}
func (params *ListSuppressionBouncesParam) SetLimit(Limit int32) *ListSuppressionBouncesParam {
	params.Limit = &Limit
	return params
}
func (params *ListSuppressionBouncesParam) SetOffset(Offset int32) *ListSuppressionBouncesParam {
	params.Offset = &Offset
	return params
}
func (params *ListSuppressionBouncesParam) SetEmail(Email string) *ListSuppressionBouncesParam {
	params.Email = &Email
	return params
}
func (params *ListSuppressionBouncesParam) SetOnbehalfof(Onbehalfof string) *ListSuppressionBouncesParam {
...
func (c *ApiService) ListSuppressionBounces(params *ListSuppressionBouncesParam) (interface{}, error) {
