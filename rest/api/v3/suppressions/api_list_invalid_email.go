...
type ListInvalidEmailParam struct {
...
func (params *ListInvalidEmailParam) SetStartTime(StartTime int32) *ListInvalidEmailParam {
	params.StartTime = &StartTime
	return params
}
func (params *ListInvalidEmailParam) SetEndTime(EndTime int32) *ListInvalidEmailParam {
	params.EndTime = &EndTime
	return params
}
func (params *ListInvalidEmailParam) SetLimit(Limit int32) *ListInvalidEmailParam {
	params.Limit = &Limit
	return params
}
func (params *ListInvalidEmailParam) SetOffset(Offset int32) *ListInvalidEmailParam {
	params.Offset = &Offset
	return params
}
func (params *ListInvalidEmailParam) SetEmail(Email string) *ListInvalidEmailParam {
	params.Email = &Email
	return params
}
func (params *ListInvalidEmailParam) SetOnbehalfof(Onbehalfof string) *ListInvalidEmailParam {
...
func (c *ApiService) ListInvalidEmail(params *ListInvalidEmailParam) (interface{}, error) {
