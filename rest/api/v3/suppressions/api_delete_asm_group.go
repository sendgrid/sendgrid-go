...
type DeleteAsmGroupParam struct {
...
func (params *DeleteAsmGroupParam) SetGroupId(GroupId string) *DeleteAsmGroupParam {
	params.GroupId = &GroupId
	return params
}
func (params *DeleteAsmGroupParam) SetOnbehalfof(Onbehalfof string) *DeleteAsmGroupParam {
...
func (c *ApiService) DeleteAsmGroup(params *DeleteAsmGroupParam) (interface{}, error) {
