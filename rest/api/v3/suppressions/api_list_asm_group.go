...
func (params *ListAsmGroupParam) SetId(Id int32) *ListAsmGroupParam {
	params.Id = &Id
	return params
}
func (params *ListAsmGroupParam) SetOnbehalfof(Onbehalfof string) *ListAsmGroupParam {
...
func (c *ApiService) ListAsmGroup(params *ListAsmGroupParam) (interface{}, error) {
	path := "/v3/asm/groups"
