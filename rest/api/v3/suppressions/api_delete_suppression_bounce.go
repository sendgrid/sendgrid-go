...
type DeleteSuppressionBounceParam struct {
...
func (params *DeleteSuppressionBounceParam) SetEmail(Email string) *DeleteSuppressionBounceParam {
	params.Email = &Email
	return params
}
func (params *DeleteSuppressionBounceParam) SetOnbehalfof(Onbehalfof string) *DeleteSuppressionBounceParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to remove an email address from your bounce list.**
func (c *ApiService) DeleteSuppressionBounce(params *DeleteSuppressionBounceParam) (interface{}, error) {
