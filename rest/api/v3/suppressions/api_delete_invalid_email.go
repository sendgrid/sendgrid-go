...
type DeleteInvalidEmailParam struct {
...
func (params *DeleteInvalidEmailParam) SetEmail(Email string) *DeleteInvalidEmailParam {
	params.Email = &Email
	return params
}
func (params *DeleteInvalidEmailParam) SetOnbehalfof(Onbehalfof string) *DeleteInvalidEmailParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to remove a specific email address from the invalid email address list.**
func (c *ApiService) DeleteInvalidEmail(params *DeleteInvalidEmailParam) (interface{}, error) {
