...
type GetSpamReportParam struct {
...
func (params *GetSpamReportParam) SetEmail(Email string) *GetSpamReportParam {
	params.Email = &Email
	return params
}
func (params *GetSpamReportParam) SetOnbehalfof(Onbehalfof string) *GetSpamReportParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve a specific spam report by email address.**
func (c *ApiService) GetSpamReport(params *GetSpamReportParam) (interface{}, error) {
