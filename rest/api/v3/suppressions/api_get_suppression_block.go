...
type GetSuppressionBlockParam struct {
...
func (params *GetSuppressionBlockParam) SetEmail(Email string) *GetSuppressionBlockParam {
	params.Email = &Email
	return params
}
func (params *GetSuppressionBlockParam) SetOnbehalfof(Onbehalfof string) *GetSuppressionBlockParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve a specific email address from your blocks list.**
func (c *ApiService) GetSuppressionBlock(params *GetSuppressionBlockParam) (interface{}, error) {
