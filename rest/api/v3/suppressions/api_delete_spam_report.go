...
type DeleteSpamReportParam struct {
...
func (params *DeleteSpamReportParam) SetEmail(Email string) *DeleteSpamReportParam {
	params.Email = &Email
	return params
}
func (params *DeleteSpamReportParam) SetOnbehalfof(Onbehalfof string) *DeleteSpamReportParam {
...
func (c *ApiService) DeleteSpamReport(params *DeleteSpamReportParam) (interface{}, error) {
