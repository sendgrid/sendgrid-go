...
type CreateGlobalSuppressionParam struct {
...
func (params *CreateGlobalSuppressionParam) SetOnbehalfof(Onbehalfof string) *CreateGlobalSuppressionParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *CreateGlobalSuppressionParam) SetSuppressionsRequest(SuppressionsRequest SuppressionsRequest) *CreateGlobalSuppressionParam {
	params.SuppressionsRequest = &SuppressionsRequest
	return params
}

// **This endpoint allows you to add one or more email addresses to the global suppressions group.**
func (c *ApiService) CreateGlobalSuppression(params *CreateGlobalSuppressionParam) (interface{}, error) {
	...
	if resp.StatusCode == 201 {
		ps := &CreateGlobalSuppression201Response{}
