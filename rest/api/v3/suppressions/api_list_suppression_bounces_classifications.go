...
type ListSuppressionBouncesClassificationsParam struct {
...
func (params *ListSuppressionBouncesClassificationsParam) SetAccept(Accept Accept) *ListSuppressionBouncesClassificationsParam {
	params.Accept = &Accept
	return params
}
func (params *ListSuppressionBouncesClassificationsParam) SetStartDate(StartDate string) *ListSuppressionBouncesClassificationsParam {
	params.StartDate = &StartDate
	return params
}
func (params *ListSuppressionBouncesClassificationsParam) SetEndDate(EndDate string) *ListSuppressionBouncesClassificationsParam {
	params.EndDate = &EndDate
	return params
}
func (params *ListSuppressionBouncesClassificationsParam) SetOnbehalfof(Onbehalfof string) *ListSuppressionBouncesClassificationsParam {
...
func (c *ApiService) ListSuppressionBouncesClassifications(params *ListSuppressionBouncesClassificationsParam) (interface{}, error) {
	...
	if resp.StatusCode == 200 {
		ps := &ListSuppressionBouncesClassifications200Response{}
