...
// Classification the model 'Classification'
type Classification string

// List of Classification
const (
	CLASSIFICATION_CONTENT                      Classification = "Content"
	CLASSIFICATION_FREQUENCY_OR_VOLUME_TOO_HIGH Classification = "Frequency or Volume Too High"
	CLASSIFICATION_INVALID_ADDRESS              Classification = "Invalid Address"
	CLASSIFICATION_MAILBOX_UNAVAILABLE          Classification = "Mailbox Unavailable"
	CLASSIFICATION_REPUTATION                   Classification = "Reputation"
	CLASSIFICATION_TECHNICAL_FAILURE            Classification = "Technical Failure"
