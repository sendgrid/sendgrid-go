...
func (params *GetAsmGroupParam) SetGroupId(GroupId string) *GetAsmGroupParam {
	params.GroupId = &GroupId
	return params
}
func (params *GetAsmGroupParam) SetOnbehalfof(Onbehalfof string) *GetAsmGroupParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve a single suppression group.**
func (c *ApiService) GetAsmGroup(params *GetAsmGroupParam) (interface{}, error) {
