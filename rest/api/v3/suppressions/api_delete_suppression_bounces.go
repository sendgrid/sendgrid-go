...
type DeleteSuppressionBouncesParam struct {
	...
	//
	DeleteSuppressionBouncesRequest *DeleteSuppressionBouncesRequest `json:"DeleteSuppressionBouncesRequest,omitempty"`
}

func (params *DeleteSuppressionBouncesParam) SetOnbehalfof(Onbehalfof string) *DeleteSuppressionBouncesParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *DeleteSuppressionBouncesParam) SetDeleteSuppressionBouncesRequest(DeleteSuppressionBouncesRequest DeleteSuppressionBouncesRequest) *DeleteSuppressionBouncesParam {
	params.DeleteSuppressionBouncesRequest = &DeleteSuppressionBouncesRequest
	return params
}
...
func (c *ApiService) DeleteSuppressionBounces(params *DeleteSuppressionBouncesParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.DeleteSuppressionBouncesRequest != nil {
		b, err := json.Marshal(*params.DeleteSuppressionBouncesRequest)
		if err != nil {
			return nil, err
		}
		body = b
