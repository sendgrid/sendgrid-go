...
type ListSpamReportParam struct {
...
func (params *ListSpamReportParam) SetStartTime(StartTime int32) *ListSpamReportParam {
	params.StartTime = &StartTime
	return params
}
func (params *ListSpamReportParam) SetEndTime(EndTime int32) *ListSpamReportParam {
	params.EndTime = &EndTime
	return params
}
func (params *ListSpamReportParam) SetLimit(Limit int32) *ListSpamReportParam {
	params.Limit = &Limit
	return params
}
func (params *ListSpamReportParam) SetOffset(Offset int32) *ListSpamReportParam {
	params.Offset = &Offset
	return params
}
func (params *ListSpamReportParam) SetEmail(Email string) *ListSpamReportParam {
	params.Email = &Email
	return params
}
func (params *ListSpamReportParam) SetOnbehalfof(Onbehalfof string) *ListSpamReportParam {
...
func (c *ApiService) ListSpamReport(params *ListSpamReportParam) (interface{}, error) {
