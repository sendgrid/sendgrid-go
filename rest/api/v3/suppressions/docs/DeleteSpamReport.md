...
------------- | ------------- | -------------
[**DeleteSpamReport**](DeleteSpamReport.md#DeleteSpamReport) | **Delete** /v3/suppression/spam_reports/{Email} | Delete a specific spam report



## DeleteSpamReport

> map[string]interface{} DeleteSpamReport(ctx, Emailoptional)
...
Other parameters are passed through a pointer to a DeleteSpamReportParams struct
