...
type ListAsmSuppressionParam struct {
...
func (params *ListAsmSuppressionParam) SetOnbehalfof(Onbehalfof string) *ListAsmSuppressionParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve a list of all suppressions.**
func (c *ApiService) ListAsmSuppression(params *ListAsmSuppressionParam) (interface{}, error) {
	...
	if resp.StatusCode == 200 {
		ps := &[]ListAsmSuppression200ResponseInner{}
