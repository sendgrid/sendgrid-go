...
type SearchSuppressionFromAsmGroupParam struct {
...
func (params *SearchSuppressionFromAsmGroupParam) SetGroupId(GroupId string) *SearchSuppressionFromAsmGroupParam {
	params.GroupId = &GroupId
	return params
}
func (params *SearchSuppressionFromAsmGroupParam) SetOnbehalfof(Onbehalfof string) *SearchSuppressionFromAsmGroupParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *SearchSuppressionFromAsmGroupParam) SetSuppressionsRequest(SuppressionsRequest SuppressionsRequest) *SearchSuppressionFromAsmGroupParam {
...
func (c *ApiService) SearchSuppressionFromAsmGroup(params *SearchSuppressionFromAsmGroupParam) (interface{}, error) {
	path := "/v3/asm/groups/{GroupId}/suppressions/search"
