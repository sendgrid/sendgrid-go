...
type DeleteSuppressionBlockParam struct {
...
func (params *DeleteSuppressionBlockParam) SetEmail(Email string) *DeleteSuppressionBlockParam {
	params.Email = &Email
	return params
}
func (params *DeleteSuppressionBlockParam) SetOnbehalfof(Onbehalfof string) *DeleteSuppressionBlockParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to delete a specific email address from your blocks list.**
func (c *ApiService) DeleteSuppressionBlock(params *DeleteSuppressionBlockParam) (interface{}, error) {
