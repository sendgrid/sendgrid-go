...
// GetAsmSuppression200Response struct for GetAsmSuppression200Response
type GetAsmSuppression200Response struct {
	// The array of suppression groups.
	Suppressions []GetAsmSuppression200ResponseSuppressionsInner `json:"suppressions"`
}
