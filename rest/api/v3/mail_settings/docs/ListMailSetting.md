...
------------- | ------------- | -------------
[**ListMailSetting**](ListMailSetting.md#ListMailSetting) | **Get** /v3/mail_settings | Retrieve all mail settings



## ListMailSetting

> ListMailSetting200Response ListMailSetting(ctx, optional)
...
Other parameters are passed through a pointer to a ListMailSettingParams struct
