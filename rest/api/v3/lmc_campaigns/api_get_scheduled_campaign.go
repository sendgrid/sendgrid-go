...
type GetScheduledCampaignParam struct {
	//
...
func (params *GetScheduledCampaignParam) SetCampaignId(CampaignId int32) *GetScheduledCampaignParam {
	params.CampaignId = &CampaignId
	return params
}
func (params *GetScheduledCampaignParam) SetOnbehalfof(Onbehalfof string) *GetScheduledCampaignParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve the date and time that a campaign has been scheduled to be sent.**
func (c *ApiService) GetScheduledCampaign(params *GetScheduledCampaignParam) (interface{}, error) {
	...
	if resp.StatusCode == 200 {
		ps := &ViewScheduledTimeOfACampaignResponse{}
