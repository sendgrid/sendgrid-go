...
func (params *GetCampaignParam) SetCampaignId(CampaignId int32) *GetCampaignParam {
	params.CampaignId = &CampaignId
	return params
}
func (params *GetCampaignParam) SetOnbehalfof(Onbehalfof string) *GetCampaignParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve a specific campaign.**
func (c *ApiService) GetCampaign(params *GetCampaignParam) (interface{}, error) {
