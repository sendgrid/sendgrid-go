...
type UnScheduleCampaignParam struct {
	//
...
func (params *UnScheduleCampaignParam) SetCampaignId(CampaignId int32) *UnScheduleCampaignParam {
	params.CampaignId = &CampaignId
	return params
}
func (params *UnScheduleCampaignParam) SetOnbehalfof(Onbehalfof string) *UnScheduleCampaignParam {
...
func (c *ApiService) UnScheduleCampaign(params *UnScheduleCampaignParam) (interface{}, error) {
