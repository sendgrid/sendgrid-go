...
type ExportSingleSendStatParam struct {
...
func (params *ExportSingleSendStatParam) SetIds(Ids []string) *ExportSingleSendStatParam {
	params.Ids = &Ids
	return params
}
func (params *ExportSingleSendStatParam) SetTimezone(Timezone string) *ExportSingleSendStatParam {
...
func (c *ApiService) ExportSingleSendStat(params *ExportSingleSendStatParam) (interface{}, error) {
