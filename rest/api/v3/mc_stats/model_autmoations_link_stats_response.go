...
// AutmoationsLinkStatsResponse struct for AutmoationsLinkStatsResponse
type AutmoationsLinkStatsResponse struct {
	//
	Results     []AutmoationsLinkStatsResponseResultsInner `json:"results"`
	TotalClicks int32                                      `json:"total_clicks"`
	Metadata    LinkTrackingMetadata                       `json:"_metadata"`
}
