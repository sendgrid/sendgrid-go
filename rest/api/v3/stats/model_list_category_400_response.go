...
// ListCategory400Response struct for ListCategory400Response
type ListCategory400Response struct {
	// The error returned.
	Errors *[]ListCategory400ResponseErrorsInner `json:"errors,omitempty"`
}
