...
// ListMailboxProviderStat200ResponseInnerStatsInner struct for ListMailboxProviderStat200ResponseInnerStatsInner
type ListMailboxProviderStat200ResponseInnerStatsInner struct {
	// The type of segmentation.
	Type *string `json:"type,omitempty"`
	// The name of the specific segmentation.
	Name    *string                       `json:"name,omitempty"`
	Metrics *AdvancedStatsMailboxProvider `json:"metrics,omitempty"`
}
