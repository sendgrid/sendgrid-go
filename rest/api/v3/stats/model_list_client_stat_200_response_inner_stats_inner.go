...
// ListClientStat200ResponseInnerStatsInner struct for ListClientStat200ResponseInnerStatsInner
type ListClientStat200ResponseInnerStatsInner struct {
	// The type of segmentation.
	Type *string `json:"type,omitempty"`
	// The name of the specific segmentation.
	Name    *string             `json:"name,omitempty"`
	Metrics *AdvancedStatsOpens `json:"metrics,omitempty"`
}
