...
type GetClientStatParam struct {
...
func (params *GetClientStatParam) SetStartDate(StartDate string) *GetClientStatParam {
	params.StartDate = &StartDate
	return params
}
func (params *GetClientStatParam) SetClientType(ClientType ClientType) *GetClientStatParam {
	params.ClientType = &ClientType
	return params
}
func (params *GetClientStatParam) SetOnbehalfof(Onbehalfof string) *GetClientStatParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *GetClientStatParam) SetEndDate(EndDate string) *GetClientStatParam {
	params.EndDate = &EndDate
	return params
}
func (params *GetClientStatParam) SetAggregatedBy(AggregatedBy AggregatedBy2) *GetClientStatParam {
...
func (c *ApiService) GetClientStat(params *GetClientStatParam) (interface{}, error) {
	path := "/v3/clients/{ClientType}/stats"
	if params != nil && params.ClientType != nil {
		path = strings.Replace(path, "{"+"ClientType"+"}", fmt.Sprint(*params.ClientType), -1)
	}
