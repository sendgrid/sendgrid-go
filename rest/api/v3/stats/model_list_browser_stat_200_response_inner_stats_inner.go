...
// ListBrowserStat200ResponseInnerStatsInner struct for ListBrowserStat200ResponseInnerStatsInner
type ListBrowserStat200ResponseInnerStatsInner struct {
	// The type of segmentation.
	Type *string `json:"type,omitempty"`
	// The name of the specific segmentation.
	Name    *string              `json:"name,omitempty"`
	Metrics *AdvancedStatsClicks `json:"metrics,omitempty"`
}
