...
// ListClientStat200ResponseInner struct for ListClientStat200ResponseInner
type ListClientStat200ResponseInner struct {
	// The date that the statistics were gathered.
	Date *string `json:"date,omitempty"`
	// The list of statistics.
	Stats *[]ListClientStat200ResponseInnerStatsInner `json:"stats,omitempty"`
}
