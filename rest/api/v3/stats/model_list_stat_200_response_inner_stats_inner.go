...
// ListStat200ResponseInnerStatsInner struct for ListStat200ResponseInnerStatsInner
type ListStat200ResponseInnerStatsInner struct {
	Metrics *StatsAdvancedGlobalStats `json:"metrics,omitempty"`
}
