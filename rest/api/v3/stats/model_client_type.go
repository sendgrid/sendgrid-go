...
// ClientType the model 'ClientType'
type ClientType string

// List of ClientType
const (
	CLIENTTYPE_PHONE   ClientType = "phone"
	CLIENTTYPE_TABLET  ClientType = "tablet"
	CLIENTTYPE_WEBMAIL ClientType = "webmail"
	CLIENTTYPE_DESKTOP ClientType = "desktop"
)
