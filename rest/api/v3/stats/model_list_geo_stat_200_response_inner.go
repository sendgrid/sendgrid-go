...
// ListGeoStat200ResponseInner struct for ListGeoStat200ResponseInner
type ListGeoStat200ResponseInner struct {
	// The date that the statistics were gathered.
	Date *string `json:"date,omitempty"`
	// The list of statistics.
	Stats *[]ListGeoStat200ResponseInnerStatsInner `json:"stats,omitempty"`
}
