...
// ListBrowserStat200ResponseInner struct for ListBrowserStat200ResponseInner
type ListBrowserStat200ResponseInner struct {
	// The date that the statistics were gathered.
	Date *string `json:"date,omitempty"`
	// The list of statistics.
	Stats *[]ListBrowserStat200ResponseInnerStatsInner `json:"stats,omitempty"`
}
