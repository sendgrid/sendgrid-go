...
// ListMailboxProviderStat200ResponseInner struct for ListMailboxProviderStat200ResponseInner
type ListMailboxProviderStat200ResponseInner struct {
	// The date that the statistics were gathered.
	Date *string `json:"date,omitempty"`
	// The list of statistics.
	Stats *[]ListMailboxProviderStat200ResponseInnerStatsInner `json:"stats,omitempty"`
}
