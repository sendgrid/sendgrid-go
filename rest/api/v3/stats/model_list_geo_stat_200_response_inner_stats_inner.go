...
// ListGeoStat200ResponseInnerStatsInner struct for ListGeoStat200ResponseInnerStatsInner
type ListGeoStat200ResponseInnerStatsInner struct {
	// The type of segmentation.
	Type *string `json:"type,omitempty"`
	// The name of the specific segmentation.
	Name    *string                   `json:"name,omitempty"`
	Metrics *AdvancedStatsClicksOpens `json:"metrics,omitempty"`
}
