...
type ListCategoryStatParam struct {
...
func (params *ListCategoryStatParam) SetStartDate(StartDate string) *ListCategoryStatParam {
	params.StartDate = &StartDate
	return params
}
func (params *ListCategoryStatParam) SetCategories(Categories string) *ListCategoryStatParam {
	params.Categories = &Categories
	return params
}
func (params *ListCategoryStatParam) SetEndDate(EndDate string) *ListCategoryStatParam {
	params.EndDate = &EndDate
	return params
}
func (params *ListCategoryStatParam) SetAggregatedBy(AggregatedBy AggregatedBy) *ListCategoryStatParam {
	params.AggregatedBy = &AggregatedBy
	return params
}
func (params *ListCategoryStatParam) SetOnbehalfof(Onbehalfof string) *ListCategoryStatParam {
...
func (c *ApiService) ListCategoryStat(params *ListCategoryStatParam) (interface{}, error) {
	...
	if params != nil && params.Categories != nil {
		data.Set("categories", *params.Categories)
	}
