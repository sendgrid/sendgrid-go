...
// ListParseStatic200ResponseInnerStatsInner struct for ListParseStatic200ResponseInnerStatsInner
type ListParseStatic200ResponseInnerStatsInner struct {
	Metrics *ListParseStatic200ResponseInnerStatsInnerMetrics `json:"metrics,omitempty"`
}
