...
// GetSignedEventWebhook404ResponseErrorsInner struct for GetSignedEventWebhook404ResponseErrorsInner
type GetSignedEventWebhook404ResponseErrorsInner struct {
	// Error message.
