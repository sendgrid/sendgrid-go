...
// ListAllSecurityPolicies200ResponsePoliciesInner struct for ListAllSecurityPolicies200ResponsePoliciesInner
type ListAllSecurityPolicies200ResponsePoliciesInner struct {
	Id        *string                                                   `json:"id,omitempty"`
	Name      *string                                                   `json:"name,omitempty"`
	Oauth     *ListAllSecurityPolicies200ResponsePoliciesInnerOauth     `json:"oauth,omitempty"`
	Signature *ListAllSecurityPolicies200ResponsePoliciesInnerSignature `json:"signature,omitempty"`
}
