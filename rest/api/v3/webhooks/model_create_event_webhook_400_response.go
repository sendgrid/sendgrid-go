...
// CreateEventWebhook400Response struct for CreateEventWebhook400Response
type CreateEventWebhook400Response struct {
	Errors *[]CreateEventWebhook400ResponseErrorsInner `json:"errors,omitempty"`
}
