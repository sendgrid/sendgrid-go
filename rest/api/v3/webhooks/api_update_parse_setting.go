...
type UpdateParseSettingParam struct {
...
func (params *UpdateParseSettingParam) SetHostname(Hostname string) *UpdateParseSettingParam {
	params.Hostname = &Hostname
	return params
}
func (params *UpdateParseSettingParam) SetOnbehalfof(Onbehalfof string) *UpdateParseSettingParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *UpdateParseSettingParam) SetParseSetting(ParseSetting ParseSetting) *UpdateParseSettingParam {
...
func (c *ApiService) UpdateParseSetting(params *UpdateParseSettingParam) (interface{}, error) {
