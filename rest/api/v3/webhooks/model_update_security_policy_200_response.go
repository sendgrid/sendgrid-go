...
// UpdateSecurityPolicy200Response struct for UpdateSecurityPolicy200Response
type UpdateSecurityPolicy200Response struct {
	Policy *UpdateSecurityPolicy200ResponsePolicy `json:"policy,omitempty"`
}
