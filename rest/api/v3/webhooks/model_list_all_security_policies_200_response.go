...
// ListAllSecurityPolicies200Response struct for ListAllSecurityPolicies200Response
type ListAllSecurityPolicies200Response struct {
	Policies *[]ListAllSecurityPolicies200ResponsePoliciesInner `json:"policies,omitempty"`
}
