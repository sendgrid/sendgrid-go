...
// ListParseStatic200ResponseInner struct for ListParseStatic200ResponseInner
type ListParseStatic200ResponseInner struct {
	// The date that the stats were collected.
	Date string `json:"date"`
	// The Parse Webhook usage statistics.
	Stats []ListParseStatic200ResponseInnerStatsInner `json:"stats"`
}
