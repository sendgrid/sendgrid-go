...
// CreateSecurityPolicy201Response struct for CreateSecurityPolicy201Response
type CreateSecurityPolicy201Response struct {
	Policy *ListAllSecurityPolicies200ResponsePoliciesInner `json:"policy,omitempty"`
}
