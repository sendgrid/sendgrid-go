...
// CreateSecurityPolicyRequest struct for CreateSecurityPolicyRequest
type CreateSecurityPolicyRequest struct {
	// User-defined policy name
	Name      *string                               `json:"name,omitempty"`
	Oauth     *CreateSecurityPolicyRequestOauth     `json:"oauth,omitempty"`
	Signature *CreateSecurityPolicyRequestSignature `json:"signature,omitempty"`
}
