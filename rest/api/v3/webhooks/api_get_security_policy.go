...
type GetSecurityPolicyParam struct {
	//
	Id *string `json:"id"`
...
func (params *GetSecurityPolicyParam) SetId(Id string) *GetSecurityPolicyParam {
	params.Id = &Id
	return params
}
func (params *GetSecurityPolicyParam) SetOnbehalfof(Onbehalfof string) *GetSecurityPolicyParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// Retrieve the details of a specific webhook security policy by its ID.
func (c *ApiService) GetSecurityPolicy(params *GetSecurityPolicyParam) (interface{}, error) {
