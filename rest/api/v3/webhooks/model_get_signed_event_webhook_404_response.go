...
// GetSignedEventWebhook404Response struct for GetSignedEventWebhook404Response
type GetSignedEventWebhook404Response struct {
	Errors *[]GetSignedEventWebhook404ResponseErrorsInner `json:"errors,omitempty"`
}
