...
type DeleteParseSettingParam struct {
...
func (params *DeleteParseSettingParam) SetHostname(Hostname string) *DeleteParseSettingParam {
	params.Hostname = &Hostname
	return params
}
func (params *DeleteParseSettingParam) SetOnbehalfof(Onbehalfof string) *DeleteParseSettingParam {
...
func (c *ApiService) DeleteParseSetting(params *DeleteParseSettingParam) (interface{}, error) {
