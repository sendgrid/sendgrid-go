...
type ListAllSecurityPoliciesParam struct {
...
func (params *ListAllSecurityPoliciesParam) SetOnbehalfof(Onbehalfof string) *ListAllSecurityPoliciesParam {
...
func (c *ApiService) ListAllSecurityPolicies(params *ListAllSecurityPoliciesParam) (interface{}, error) {
	...
	if resp.StatusCode == 200 {
		ps := &ListAllSecurityPolicies200Response{}
