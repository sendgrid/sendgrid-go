...
// ValidateEmail200ResponseResultChecks Granular checks for email address validity.
type ValidateEmail200ResponseResultChecks struct {
	Domain     ValidateEmail200ResponseResultChecksDomain     `json:"domain"`
	LocalPart  ValidateEmail200ResponseResultChecksLocalPart  `json:"local_part"`
	Additional ValidateEmail200ResponseResultChecksAdditional `json:"additional"`
}
