...
// GetValidationsEmailJobs200Response struct for GetValidationsEmailJobs200Response
type GetValidationsEmailJobs200Response struct {
	//
	Result *[]GetValidationsEmailJobs200ResponseResultInner `json:"result,omitempty"`
}
