...
// GetValidationsEmailJobsJobId200Response struct for GetValidationsEmailJobsJobId200Response
type GetValidationsEmailJobsJobId200Response struct {
	Result *GetValidationsEmailJobsJobId200ResponseResult `json:"result,omitempty"`
}
