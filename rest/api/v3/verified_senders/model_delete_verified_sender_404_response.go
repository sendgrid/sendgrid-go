...
// DeleteVerifiedSender404Response struct for DeleteVerifiedSender404Response
type DeleteVerifiedSender404Response struct {
	Errors []DeleteVerifiedSender403ResponseErrorsInner `json:"errors"`
}
