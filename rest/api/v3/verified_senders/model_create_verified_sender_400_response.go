...
// CreateVerifiedSender400Response struct for CreateVerifiedSender400Response
type CreateVerifiedSender400Response struct {
	Errors []CreateVerifiedSender400ResponseErrorsInner `json:"errors"`
}
