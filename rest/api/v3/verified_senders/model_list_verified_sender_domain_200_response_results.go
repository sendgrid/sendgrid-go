...
// ListVerifiedSenderDomain200ResponseResults struct for ListVerifiedSenderDomain200ResponseResults
type ListVerifiedSenderDomain200ResponseResults struct {
	SoftFailures []string `json:"soft_failures"`
