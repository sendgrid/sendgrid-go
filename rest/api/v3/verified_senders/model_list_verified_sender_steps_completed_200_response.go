...
// ListVerifiedSenderStepsCompleted200Response struct for ListVerifiedSenderStepsCompleted200Response
type ListVerifiedSenderStepsCompleted200Response struct {
	Results *ListVerifiedSenderStepsCompleted200ResponseResults `json:"results,omitempty"`
}
