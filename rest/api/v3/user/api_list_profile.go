...
func (params *ListProfileParam) SetOnbehalfof(Onbehalfof string) *ListProfileParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve your current profile details.**
func (c *ApiService) ListProfile(params *ListProfileParam) (interface{}, error) {
