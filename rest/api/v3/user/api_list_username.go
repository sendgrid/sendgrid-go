...
func (params *ListUsernameParam) SetOnbehalfof(Onbehalfof string) *ListUsernameParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve your current account username.**
func (c *ApiService) ListUsername(params *ListUsernameParam) (interface{}, error) {
