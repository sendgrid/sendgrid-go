...
func (params *ListEmailParam) SetOnbehalfof(Onbehalfof string) *ListEmailParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve the email address currently on file for your account.**
func (c *ApiService) ListEmail(params *ListEmailParam) (interface{}, error) {
	path := "/v3/user/email"
