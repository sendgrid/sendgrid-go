...
type UpdatePasswordParam struct {
	...
	//
	UpdatePasswordRequest *UpdatePasswordRequest `json:"UpdatePasswordRequest,omitempty"`
}

func (params *UpdatePasswordParam) SetOnbehalfof(Onbehalfof string) *UpdatePasswordParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *UpdatePasswordParam) SetUpdatePasswordRequest(UpdatePasswordRequest UpdatePasswordRequest) *UpdatePasswordParam {
	params.UpdatePasswordRequest = &UpdatePasswordRequest
	return params
}

// **This endpoint allows you to update your password.**
func (c *ApiService) UpdatePassword(params *UpdatePasswordParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.UpdatePasswordRequest != nil {
		b, err := json.Marshal(*params.UpdatePasswordRequest)
		if err != nil {
			return nil, err
		}
		body = b
