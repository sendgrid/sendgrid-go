...
func (params *UpdateProfileParam) SetOnbehalfof(Onbehalfof string) *UpdateProfileParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *UpdateProfileParam) SetUserProfile(UserProfile UserProfile) *UpdateProfileParam {
...
func (c *ApiService) UpdateProfile(params *UpdateProfileParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.UserProfile != nil {
		b, err := json.Marshal(*params.UserProfile)
		if err != nil {
			return nil, err
		}
		body = b
