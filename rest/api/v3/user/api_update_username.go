...
type UpdateUsernameParam struct {
	...
	//
	UpdateUsernameRequest *UpdateUsernameRequest `json:"UpdateUsernameRequest,omitempty"`
}

func (params *UpdateUsernameParam) SetOnbehalfof(Onbehalfof string) *UpdateUsernameParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *UpdateUsernameParam) SetUpdateUsernameRequest(UpdateUsernameRequest UpdateUsernameRequest) *UpdateUsernameParam {
	params.UpdateUsernameRequest = &UpdateUsernameRequest
	return params
}

// **This endpoint allows you to update the username for your account.**
func (c *ApiService) UpdateUsername(params *UpdateUsernameParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.UpdateUsernameRequest != nil {
		b, err := json.Marshal(*params.UpdateUsernameRequest)
		if err != nil {
			return nil, err
		}
		body = b
