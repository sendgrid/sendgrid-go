...
// ListExportRecipient200Response struct for ListExportRecipient200Response
type ListExportRecipient200Response struct {
	Result   *[]ListExportRecipient200ResponseResultInner `json:"result,omitempty"`
	Metadata *ListExportRecipient200ResponseMetadata      `json:"_metadata,omitempty"`
}
