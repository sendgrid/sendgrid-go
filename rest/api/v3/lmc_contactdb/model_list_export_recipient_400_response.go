...
// ListExportRecipient400Response struct for ListExportRecipient400Response
type ListExportRecipient400Response struct {
	Errors *[]ListExportRecipient400ResponseErrorsInner `json:"errors,omitempty"`
}
