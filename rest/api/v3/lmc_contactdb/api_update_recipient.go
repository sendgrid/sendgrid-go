...
func (params *UpdateRecipientParam) SetUpdateRecipientRequestInner(UpdateRecipientRequestInner []UpdateRecipientRequestInner) *UpdateRecipientParam {
	params.UpdateRecipientRequestInner = &UpdateRecipientRequestInner
	return params
}
...
func (c *ApiService) UpdateRecipient(params *UpdateRecipientParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.UpdateRecipientRequestInner != nil {
		b, err := json.Marshal(*params.UpdateRecipientRequestInner)
		if err != nil {
			return nil, err
		}
		body = b
