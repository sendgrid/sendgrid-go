...
// OutboundIpType the model 'OutboundIpType'
type OutboundIpType string

// List of OutboundIpType
const (
	OUTBOUNDIPTYPE_DEDICATED OutboundIpType = "dedicated"
	OUTBOUNDIPTYPE_SHARED    OutboundIpType = "shared"
)
