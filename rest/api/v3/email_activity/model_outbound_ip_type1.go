...
// OutboundIpType1 the model 'OutboundIpType1'
type OutboundIpType1 string

// List of OutboundIpType1
const (
	OUTBOUNDIPTYPE1_DEDICATED OutboundIpType1 = "dedicated"
	OUTBOUNDIPTYPE1_SHARED    OutboundIpType1 = "shared"
)
