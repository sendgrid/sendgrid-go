...
// ListMessage429Response struct for ListMessage429Response
type ListMessage429Response struct {
	Errors *[]ListMessage429ResponseErrorsInner `json:"errors,omitempty"`
}
