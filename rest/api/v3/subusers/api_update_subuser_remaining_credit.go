...
func (c *ApiService) UpdateSubuserRemainingCredit(params *UpdateSubuserRemainingCreditParam) (interface{}, error) {
	path := "/v3/subusers/{SubuserName}/credits/remaining"
	...
	body := []byte{}
	if params != nil && params.UpdateSubuserRemainingCreditRequest != nil {
		b, err := json.Marshal(*params.UpdateSubuserRemainingCreditRequest)
		if err != nil {
			return nil, err
		}
		body = b
