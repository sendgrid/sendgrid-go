...
type UpdateMarketingListParam struct {
	// The ID of the list on which you want to perform the operation.
	Id *string `json:"id"`
	//
	UpdateMarketingListRequest *UpdateMarketingListRequest `json:"UpdateMarketingListRequest,omitempty"`
}

func (params *UpdateMarketingListParam) SetId(Id string) *UpdateMarketingListParam {
	params.Id = &Id
	return params
}
func (params *UpdateMarketingListParam) SetUpdateMarketingListRequest(UpdateMarketingListRequest UpdateMarketingListRequest) *UpdateMarketingListParam {
	params.UpdateMarketingListRequest = &UpdateMarketingListRequest
	return params
}

// **This endpoint updates the name of a list.**
func (c *ApiService) UpdateMarketingList(params *UpdateMarketingListParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.UpdateMarketingListRequest != nil {
		b, err := json.Marshal(*params.UpdateMarketingListRequest)
		if err != nil {
			return nil, err
		}
		body = b
