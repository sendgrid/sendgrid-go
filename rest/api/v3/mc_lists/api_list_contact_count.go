...
func (params *ListContactCountParam) SetId(Id string) *ListContactCountParam {
	params.Id = &Id
	return params
}

// **This endpoint returns the number of contacts on a specific list.**
func (c *ApiService) ListContactCount(params *ListContactCountParam) (interface{}, error) {
	...
	if resp.StatusCode == 200 {
		ps := &ListContactCount200Response{}
