...
type ListPartnerSettingParam struct {
...
func (params *ListPartnerSettingParam) SetLimit(Limit int32) *ListPartnerSettingParam {
	params.Limit = &Limit
	return params
}
func (params *ListPartnerSettingParam) SetOffset(Offset int32) *ListPartnerSettingParam {
	params.Offset = &Offset
	return params
}
func (params *ListPartnerSettingParam) SetOnbehalfof(Onbehalfof string) *ListPartnerSettingParam {
...
func (c *ApiService) ListPartnerSetting(params *ListPartnerSettingParam) (interface{}, error) {
	...
	if resp.StatusCode == 200 {
		ps := &ListPartnerSetting200Response{}
