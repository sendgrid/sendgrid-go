...
// CreateAccountParams struct for CreateAccountParams
type CreateAccountParams struct {
	Profile *AccountProvisioningProfile `json:"profile,omitempty"`
	// List of offering names to assign to account.
	Offerings []AccountProvisioningOfferingV1 `json:"offerings"`
}
