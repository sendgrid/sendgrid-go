...
type UpdateClickTrackingSettingParam struct {
	...
	//
	UpdateClickTrackingSettingRequest *UpdateClickTrackingSettingRequest `json:"UpdateClickTrackingSettingRequest,omitempty"`
}

func (params *UpdateClickTrackingSettingParam) SetOnbehalfof(Onbehalfof string) *UpdateClickTrackingSettingParam {
	params.Onbehalfof = &Onbehalfof
	return params
}
func (params *UpdateClickTrackingSettingParam) SetUpdateClickTrackingSettingRequest(UpdateClickTrackingSettingRequest UpdateClickTrackingSettingRequest) *UpdateClickTrackingSettingParam {
	params.UpdateClickTrackingSettingRequest = &UpdateClickTrackingSettingRequest
	return params
}
...
func (c *ApiService) UpdateClickTrackingSetting(params *UpdateClickTrackingSettingParam) (interface{}, error) {
	...
	body := []byte{}
	if params != nil && params.UpdateClickTrackingSettingRequest != nil {
		b, err := json.Marshal(*params.UpdateClickTrackingSettingRequest)
		if err != nil {
			return nil, err
		}
		body = b
