...
type ListSubscriptionTrackingSettingParam struct {
...
func (params *ListSubscriptionTrackingSettingParam) SetOnbehalfof(Onbehalfof string) *ListSubscriptionTrackingSettingParam {
...
func (c *ApiService) ListSubscriptionTrackingSetting(params *ListSubscriptionTrackingSettingParam) (interface{}, error) {
