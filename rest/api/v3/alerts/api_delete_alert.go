...
func (params *DeleteAlertParam) SetAlertId(AlertId int32) *DeleteAlertParam {
	params.AlertId = &AlertId
	return params
}
func (params *DeleteAlertParam) SetOnbehalfof(Onbehalfof string) *DeleteAlertParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to delete an alert.**
func (c *ApiService) DeleteAlert(params *DeleteAlertParam) (interface{}, error) {
