...
func (params *GetAlertParam) SetAlertId(AlertId int32) *GetAlertParam {
	params.AlertId = &AlertId
	return params
}
func (params *GetAlertParam) SetOnbehalfof(Onbehalfof string) *GetAlertParam {
	params.Onbehalfof = &Onbehalfof
	return params
}

// **This endpoint allows you to retrieve a specific alert.**
func (c *ApiService) GetAlert(params *GetAlertParam) (interface{}, error) {
