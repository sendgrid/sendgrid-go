...
// CreateNewSuppressionGroup Create a new suppression group
// POST /asm/groups
func CreateNewSuppressionGroup() {
...
// RetrieveSuppressionGroupsInfo Retrieve information about multiple suppression groups
// GET /asm/groups
func RetrieveSuppressionGroupsInfo() {
	apiKey := os.Getenv("YOUR_SENDGRID_APIKEY")
	host := "https://api.sendgrid.com"
	request := sendgrid.GetRequest(apiKey, "/v3/asm/groups", host)
	request.Method = "GET"
...
// RetrieveAllSuppressionsFromGroup Retrieve all suppressions for a suppression group
// GET /asm/groups/{group_id}/suppressions
func RetrieveAllSuppressionsFromGroup() {
	apiKey := os.Getenv("YOUR_SENDGRID_APIKEY")
	host := "https://api.sendgrid.com"
	request := sendgrid.GetRequest(apiKey, "/v3/asm/groups/{group_id}/suppressions", host)
	request.Method = "GET"
...
// RetrieveGlobalSuppression Retrieve a Global Suppression
// GET /asm/suppressions/global/{email}
func RetrieveGlobalSuppression() {
	apiKey := os.Getenv("YOUR_SENDGRID_APIKEY")
	host := "https://api.sendgrid.com"
...
// RetrieveAllSuppressionGroupsByEmail Retrieve all suppression groups for an email address
// GET /asm/suppressions/{email}
func RetrieveAllSuppressionGroupsByEmail() {
	apiKey := os.Getenv("YOUR_SENDGRID_APIKEY")
	host := "https://api.sendgrid.com"
